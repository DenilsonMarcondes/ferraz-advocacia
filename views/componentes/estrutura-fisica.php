<style type="text/css">
	a.hover-matriz:hover .number,
	a.hover-matriz:hover .number.active,
	a.hover-matriz-active:hover .number,
	a.hover-matriz-active:hover .number.active { color: #242367 }

	.session-estrutura .row-second a.hover-matriz .col { height: 448px }
	.session-estrutura .row-second a.hover-matriz .col { border-right: 1px solid #242367 }
	.session-estrutura .row-second a.hover-matriz:last-child .col { border-right: none }
	.session-estrutura .row-second a.hover-matriz .col .item-title { margin-top: 30px; margin-bottom: 30px }

	.background-matriz { height: 192px; padding: 0 }

	.number { color: #b1b1b1; line-height: 1.2; padding-top: 53px; padding-bottom: 23px; margin: 0; }
	.number.active { color: #b1b1b1; line-height: 1.2; padding-top: 0px; padding-bottom: 10px; margin: 0; }
	...
	<div class="container">
		...
		<div class="row row-first">
			<div class="col-lg-9 col-md-9 col-sm-9 hidden-xs" style="padding: 0">
				<div class="col-lg-12 col-md-12 col-sm-12 background-matriz">
					<div class="col-lg-4 col-md-4 col-sm-4 hidden-xs" style="border-right: 1px solid #242367; height: 100%; padding: 0">&nbsp;</div>
					<div class="col-lg-4 col-md-4 col-sm-4 hidden-xs" style="border-right: 1px solid #242367; height: 100%; padding: 0">&nbsp;</div>
					<div class="col-lg-4 col-md-4 col-sm-4 hidden-xs" style="border-right: 1px solid #242367; height: 100%; padding: 0">&nbsp;</div>
				</div>
			</div>
			<a href="<?= RAIZSITE ?>/contato/#matrizCuritiba" class="hover-matriz-active">
