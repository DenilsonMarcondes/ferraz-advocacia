<style type="text/css">
	...
	@media screen and (min-width: 768px) {
		...
		.navbar-default.cinza { background-color: #f5f5f5; border: none }
		...
		.navbar-default.cinza .navbar-nav>li>a { color: #242367 }
...
<style type="text/css">
	...
	*/
	...
	.row-historia .line { -webkit-transition: all 0.6s ease-out; transition: all 0.6s ease-out }
	.row-historia .line { width: 0%; top: 112px; right: 0; }
...
<div class="row-historia after-scrolled">
	<div class="container">
		<div class="row">
...
<script type="text/javascript">
	$(document).scroll(function() {
		if ($(this).scrollTop() > 150) {
			$(".historia-content .line").css('width', '75%');
...
<style type="text/css">
	...
	*/
	...
	@media screen and (min-width: 768px) {
		...
		.session-atuacao-destaques p.bread-crumb-title { color: #b1b1b1; opacity: 9; margin-left: 0 }
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-atuacoes">
				...
				<a href="<?= RAIZSITE ?>/areas-de-atuacao/#negociacao">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 atuacao-item">
				...
				<a href="<?= RAIZSITE ?>/areas-de-atuacao/#cobranca">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 atuacao-item">
				...
				<a href="<?= RAIZSITE ?>/areas-de-atuacao/#solicitacao">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 atuacao-item">
...
<div class="session-atuacao">
	<div class="container">
		<div class="row">
			<a href="<?= RAIZSITE ?>/areas-de-atuacao/#equipes">
			...
			<a href="<?= RAIZSITE ?>/areas-de-atuacao/#solucoes">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 atuacao-item">
			...
			<a href="<?= RAIZSITE ?>/areas-de-atuacao/#recuperacaojudicial">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 atuacao-item">
			...
			<a href="<?= RAIZSITE ?>/areas-de-atuacao/#complexidade">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 atuacao-item">
